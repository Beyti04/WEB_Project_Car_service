...
<head>
    ...
    <title>My Dashboard - Car Service</title>
                ...
                <div class="layout-content-container flex flex-col max-w-[1200px] flex-1">
                    <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#dbe0e6] dark:border-gray-700 px-4 sm:px-6 md:px-10 py-3 bg-white dark:bg-background-dark rounded-xl">
                        <a href="index.php" class="flex items-center gap-4 text-[#111418] dark:text-white">
                            ...
                            <h2 class="text-[#111418] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">Car Service Client Portal</h2>
                        </a>
                        <div class="flex flex-1 justify-end items-center gap-4 sm:gap-6 md:gap-8">
                            <div class="hidden md:flex items-center gap-8">
                                ...
                                <a class="text-primary dark:text-white text-sm font-bold leading-normal" href="#">My Vehicles</a>
                            </div>
                    ...
                    <main class="flex flex-col gap-6 pt-6">
                        <div class="flex flex-wrap justify-between items-center gap-4 p-4">
                            <p class="text-[#111418] dark:text-white text-4xl font-black leading-tight tracking-[-0.033em] min-w-72">My Vehicles & Service History</p>
                        </div>
                        <div class="flex flex-col md:flex-row justify-between gap-4 px-4 py-3">
                            <div class="relative flex-1 min-w-[280px]">
                                ...
                                <input class="w-full h-10 pl-10 pr-4 rounded-lg border border-[#dbe0e6] dark:border-gray-700 bg-white dark:bg-background-dark text-sm focus:ring-2 focus:ring-primary focus:border-primary dark:text-white" placeholder="Search by make, model, or service..." type="text" />
                            </div>
                            <div class="flex gap-2">
                                <button class="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-white dark:bg-background-dark border border-[#dbe0e6] dark:border-gray-700 text-[#111418] dark:text-white gap-2 text-sm font-medium leading-normal min-w-0 px-4 hover:bg-gray-50 dark:hover:bg-gray-800">
                                    ...
                                    <span class="truncate">Filter History</span>
                                </button>
                                ...
                                <table class="flex-1 w-full">
                                    <thead>
                                        <tr class="bg-gray-50 dark:bg-gray-800/50">
                                            <th class="px-4 py-3 text-left text-[#111418] dark:text-gray-300 text-sm font-medium leading-normal w-1/4">Vehicle</th>
                                            <th class="px-4 py-3 text-left text-[#111418] dark:text-gray-300 text-sm font-medium leading-normal w-1/4">License Plate</th>
                                            <th class="px-4 py-3 text-left text-[#111418] dark:text-gray-300 text-sm font-medium leading-normal w-1/4">Last Service Date</th>
                                    ...
                                    <tbody>
                                        <tr class="border-t border-t-[#dbe0e6] dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                            <td class="h-[72px] px-4 py-2 text-[#111418] dark:text-white text-sm font-normal leading-normal">Ford F-150 (2020)</td>
                                            <td class="h-[72px] px-4 py-2 text-[#617589] dark:text-gray-400 text-sm font-normal leading-normal">XYZ 456</td>
                                            <td class="h-[72px] px-4 py-2 text-[#617589] dark:text-gray-400 text-sm font-normal leading-normal">2025-10-25</td>
                                            <td class="h-[72px] px-4 py-2">
                                                <div class="flex gap-2 text-[#617589] dark:text-gray-400">
                                                    <button class="flex items-center justify-center p-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-primary group/action">
                                                        <span class="material-symbols-outlined text-xl">history</span>
                                                        <span class="sr-only group-hover/action:not-sr-only group-hover/action:ml-1 text-xs">Service History</span>
                                                    </button>
                                                    <button class="flex items-center justify-center p-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-primary group/action">
                                                        <span class="material-symbols-outlined text-xl">edit_calendar</span>
                                                        <span class="sr-only group-hover/action:not-sr-only group-hover/action:ml-1 text-xs">Book Service</span>
                                                    </button>
                                                    <button class="flex items-center justify-center p-2 rounded-md hover:bg-red-100 dark:hover:bg-red-900/50 hover:text-red-600 dark:hover:text-red-500 group/action">
                                                        <span class="material-symbols-outlined text-xl">delete</span>
                                                        <span class="sr-only group-hover/action:not-sr-only group-hover/action:ml-1 text-xs">Remove Vehicle</span>
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr class="border-t border-t-[#dbe0e6] dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                            <td class="h-[72px] px-4 py-2 text-[#111418] dark:text-white text-sm font-normal leading-normal">Honda Civic (2018)</td>
                                            <td class="h-[72px] px-4 py-2 text-[#617589] dark:text-gray-400 text-sm font-normal leading-normal">ABC 123</td>
                                            <td class="h-[72px] px-4 py-2 text-[#617589] dark:text-gray-400 text-sm font-normal leading-normal">2025-05-10</td>
                                            <td class="h-[72px] px-4 py-2">
                                                <div class="flex gap-2 text-[#617589] dark:text-gray-400">
                                                    <button class="flex items-center justify-center p-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-primary group/action">
                                                        <span class="material-symbols-outlined text-xl">history</span>
                        ...
                        <div class="flex items-center justify-center p-4">
                            ...
                            <a class="text-sm font-normal leading-normal flex size-10 items-center justify-center text-[#111418] dark:text-white rounded-full hover:bg-gray-200 dark:hover:bg-gray-800" href="#">5</a>
                            <a class="flex size-10 items-center justify-center text-[#111418] dark:text-gray-400 hover:text-primary dark:hover:text-primary" href="#">
