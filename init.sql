...
-- Групи
INSERT INTO service_groups (name) VALUES ('Обслужване'), ('Диагностика'), ('Климатизация'), ('Двигател'),('Транзмисия') ('Окачване');
...
('Смяна на масло на трансмисията', 100.00, 1),
...
('Смяна на маслен филтър', 25.00, 1),
...
('Адаптация на трансмисия', 120.00, 5),
('Цялостна смяна на трансмисия', 1200.00, 5),
('Рециклаж на трансмисия', 1300.00, 5),
...
('Смяна на спирачни накладки', 120.00, 6),
('Смяна на спирачни дискове', 160.00, 6),
('Смяна на спирачни апарати', 220.00, 6);
