...
('Масло 0W-20 (1L)', 100, 30.00, 1),
('Масло 0W-30 (1L)', 100, 28.00, 1),
('Масло 5W-30 (1L)', 100, 26.00, 1),
('Масло 5W-40 (1L)', 100, 25.00, 1),
('Масло 10W-40 (1L)', 100, 20.00, 1),
('Масло 0W-20 (5L)', 100, 30.00, 1),
('Масло 0W-30 (5L)', 100, 28.00, 1),
('Масло 5W-30 (5L)', 100, 26.00, 1),
('Масло 5W-40 (5L)', 100, 25.00, 1),
('Масло 10W-40 (5L)', 100, 20.00, 1),

('Спирачна течност (1L)', 80, 15.00, 2),
('Спирачна течност (5L)', 80, 15.00, 2),
('Хидравлична течност (1L)', 80, 18.00, 2),
('Хидравлична течност (5L)', 80, 18.00, 2),
('AdBlue (1L)', 90, 5.00, 2),
('AdBlue (5L)', 90, 5.00, 2),
('Охладителна течност (1L)', 80, 12.00, 2),
('Охладителна течност (5L)', 80, 12.00, 2),

('Филтър масло на двигателя', 50, 12.00, 3),
('Филтър масло на скоростна кутия', 50, 12.00, 3),
('Филтър въздух', 50, 10.00, 3),
('Филтър купе', 50, 8.00, 3),
('Филтър гориво', 50, 14.00, 3),

('Почистващ агент за климатик', 70, 10.00, 4),
('Фреон климатик (1L)', 60, 20.00, 4),
('Компресор климатик', 20, 150.00, 4),
('Радиатор климатик', 30, 120.00, 4),

('Ремък генератор', 40, 35.00, 5),
('Ангренажен ремък', 40, 50.00, 5),
('Водна помпа', 40, 45.00, 5),
('Термостат', 40, 30.00, 5),
('Радиатор', 30, 80.00, 5),
('Турбо', 20, 250.00, 5),
('Свещи (комплект)', 50, 40.00, 5),

('Скоростна кутия (автоматична)', 10, 800.00, 6),
('Скоростна кутия (ръчна)', 15, 600.00, 6),
('Соленоиди', 25, 90.00, 6),
('Синхронизатори (комплект)', 20, 150.00, 6),
('Съединител (комплект)', 30, 120.00, 6),
('Диференциал', 15, 300.00, 6),
('Кардан', 20, 180.00, 6),
('Карета', 30, 60.00, 6),

('Пружини (предни)', 40, 70.00, 7),
('Пружини (задни)', 40, 65.00, 7),
('Амортисьори (предни)', 50, 80.00, 7),
('Амортисьори (задни)', 50, 75.00, 7),
('Носачи (предни)', 60, 90.00, 7),
('Носачи (задни)', 60, 85.00, 7),
('Тампони носачи', 70, 40.00, 7),
('Биалетки', 80, 35.00, 7),
('Стабилизираща щанга', 70, 30.00, 7),
('Шарнири', 60, 45.00, 7),

('Спирачни накладки (предни)', 60, 70.00, 7),
('Спирачни накладки (задни)', 60, 65.00, 7),
('Спирачни дискове (предни)', 50, 90.00, 7),
('Спирачни дискове (задни)', 50, 85.00, 7);
('Спирачни апарати (предни)', 40, 120.00, 7),
('Спирачни апарати (задни)', 40, 110.00, 7),
('Спирачна помпа', 30, 150.00, 7),
('ABS модул', 20, 250.00, 7);
