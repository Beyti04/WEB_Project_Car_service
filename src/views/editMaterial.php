...
<head>
    ...
    <title>Edit Material - TU Service</title>
...
<body class="font-display bg-background-light dark:bg-background-dark text-[#333333] dark:text-gray-200">
    ...
    $material = Material::getMaterialById((int)$materialId);
    $materialGroup = MaterialGroup::getAllMaterialGroups();
    $groupNames = [];
                    ...
                    <form action="index.php?action=updateMaterial&material_id=<?php echo htmlspecialchars($material->id ?? ''); ?>" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="quantity" required
                                class="w-full rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600"
                                value="<?php echo htmlspecialchars($material->stock ?? ''); ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="price" required
                                class="w-full rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600"
                                value="<?php echo htmlspecialchars($material->unit_price ?? ''); ?>">
                        </div>
