...
$pdf->Cell(0, 10, 'Месечен доклад', 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->SetFont('DejaVu', 'B', 12);
    $pdf->Cell(0, 10, 'Total Revenue: €' . number_format($monthlyRevenue, 2), 0, 1, 'R');
