...
<head>
    ...
    <title>TU Service - Car Service Management System</title>
                ...
                <div class="flex items-center justify-between w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-3">
                    ...
                    <div class="flex flex-1 justify-end items-center gap-8">
                        <div class="flex gap-2">
                            ...
                            <a class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white dark:bg-secondary dark:text-primary text-sm font-bold leading-normal tracking-[0.015em] hover:opacity-90 transition-opacity" href="index.php?action=register">
