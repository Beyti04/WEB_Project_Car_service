...
$pdf->Cell(0, 10, 'TU Service', 0, 1, 'C');
...
$pdf->SetFont('DejaVu', 'B', 10);
$pdf->Cell(40, 6, 'Employee:', 0, 0);
$pdf->SetFont('DejaVu', '', 12);
$pdf->Cell(0, 6, $order['employee_name'], 0, 1);
$pdf->Ln(5);
...
$pdf->SetFont('DejaVu', '', 12);
$pdf->Cell(0, 6, "{$order['car_year']} {$order['brand_name']} {$order['model_name']} VIN: {$order['vin']}", 0, 1);

$pdf->Ln(5);

// ===== MATERIALS TABLE =====
$pdf->SetFont('DejaVu', 'B', 10);
$pdf->Cell(100, 6, 'Items', 1, 0, 'C');
$pdf->Cell(40, 6, 'Quantity', 1, 0, 'C');
$pdf->Cell(50, 6, 'Price (€)', 1, 1, 'C');

$pdf->SetFont('DejaVu', '', 10);
$pdf->Cell(100, 6, $order['service_name'], 1, 0);
$pdf->Cell(40, 6, 1, 1, 0, 'C');
$pdf->Cell(50, 6, number_format($order['base_price'], 2), 1, 1, 'R');
